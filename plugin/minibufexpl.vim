...
if g:miniBufExplMapCTabSwitchBufs
  ...
  noremap <C-S-Right>   :call <SID>CycleBuffer(1)<CR>:<BS>
  noremap <C-M>   :call <SID>CycleBuffer(1)<CR>:<BS>
  noremap <C-S-Left> :call <SID>CycleBuffer(0)<CR>:<BS>
  noremap <C-N> :call <SID>CycleBuffer(0)<CR>:<BS>
endif
